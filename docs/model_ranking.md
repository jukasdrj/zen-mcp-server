...
|--------------|-------------------------------------------------------------------------------------------|
| 18–19 | Frontier reasoning models (Gemini 3.0 Pro Preview, Gemini 3.0 Flash Preview, Gemini 2.5 Pro, GPT‑5.1 Codex, GPT‑5.2 Pro, GPT‑5.2, GPT‑5) |
...
| 9–11  | Fast distillations (Gemini 2.5 Flash, GPT-5 Mini, Mistral medium)                             |
| 6–8   | Local or efficiency-focused models (Llama 3 70B, Claude Haiku)                            |
| ≤5    | Experimental/lightweight models (Gemini 2.5 Flash Lite)                                                           |
