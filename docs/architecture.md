...
- **[Development Guide](../CLAUDE.md)** - Active development commands and workflows
- **[Contributing Guide](contributions.md)** - How to contribute to the project
- **[Adding Providers](adding_providers.md)** - Provider implementation guide
- **[Adding Tools](adding_tools.md)** - Tool implementation guide
